    ...
    return (
        <div className="container-fluid p-0">
            ...
            <header className="bg-secondary text-white text-center py-5">
                <h1 className="display-4">Pedidos de Cliente</h1>
                <p className="lead">Gestion de pedidos de cliente y consulta de información </p>
            </header>
            ...
            <div className="container-fluid">
                <div className="container my-2 pb-5">
                    <div className="d-flex justify-content-between mx-3 ">
                        ...
                        <Link to="/add-customer-order">
                            <button onClick={handleAddOrder} type="button" className="btn btn-secondary me-4">
