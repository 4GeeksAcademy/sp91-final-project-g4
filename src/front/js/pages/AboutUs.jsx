        ...
        <div className="row align-items-center">
          <div className="col-md-6 order-md-1">
            <p className="lead">
              ...
              en marcha este proyecto innovador.<p></p>
			  <strong>Marcos Sevilla, Natalia Manzano y Ricardo Franco, </strong>
			  tras pasar un tiempo en <strong>4geeks acedemy</strong> unieron su visión y pasión y crearon este projecto 
			  dedicado al transporte seguro y eficiente.
            </p>
          </div>
